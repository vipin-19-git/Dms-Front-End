...
class ProductEdit extends React.Component {
  ...
  async componentDidMount()
  {
   ...
   Api.getData(`/product/edit/${file_id}`,'').then((res)=>{
  
    console.log(res.data.result.statecode);
    this.setState({product_cd:res.data.result.productcode})
    this.setState({product_nm:res.data.result.productname})
    this.setState({prod_desc:res.data.result.description})
   }) 
  ...
  submitButton = async (e) => {
   ...
   // console.log(e.target.elements);
    let fileData = {product_cd:this.state.product_cd,product_nm: this.state.product_nm,prod_desc: this.state.prod_desc};
    Api.postData('/product/update', fileData).then(res =>{
