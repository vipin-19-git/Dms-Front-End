                                ...
                                <p style={{color:this.state.msgColor,fontWeight:"bold"}}>{this.state.msg}</p>
                                    ...
                                    <form action="">
                                     ...
                                     <input type="text" className="form-control" name="username" id="username"
                                      placeholder="Enter username"  value={this.state.username}  onChange={this.onChangehandler}/>
                                        </div>
                
                                        <div className="mb-3">
                                        <label style={{marginRight: "700px"}}  className="form-label" htmlFor="userpassword">Password</label>
                                   <input type="password" className="form-control" id="password" name="password" 
                                    placeholder="Enter password" value={this.state.password} onChange={this.onChangehandler} />
                                        </div>
